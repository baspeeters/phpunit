--TEST--
phpunit --colors=never --coverage-clover=/foo/bar/baz ../../_files/phpt-for-coverage.phpt --whitelist ../../_files/CoveredClass.php
--SKIPIF--
...
$_SERVER['argv'][5] = '--coverage-clover=/foo/bar/baz';
...
Generating code coverage report in Clover XML format ... failed [%d ms]
