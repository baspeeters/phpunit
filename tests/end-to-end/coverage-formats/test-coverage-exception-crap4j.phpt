--TEST--
phpunit --colors=never --coverage-crap4j=/foo/bar/baz ../../_files/phpt-for-coverage.phpt --whitelist ../../_files/CoveredClass.php
--SKIPIF--
...
$_SERVER['argv'][5] = '--coverage-crap4j=/foo/bar/baz';
...
Generating code coverage report in Crap4J XML format ... failed [%d ms]
Directory "/foo/bar" was not created
