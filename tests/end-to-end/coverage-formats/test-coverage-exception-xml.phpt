--TEST--
phpunit --colors=never --coverage-xml=/foo/bar/baz ../../_files/phpt-for-coverage.phpt --whitelist ../../_files/CoveredClass.php
--SKIPIF--
...
$_SERVER['argv'][5] = '--coverage-xml=/foo/bar/baz';
...
Generating code coverage report in PHPUnit XML format ... failed [%d ms]
'/foo/bar/baz/' could not be created.
